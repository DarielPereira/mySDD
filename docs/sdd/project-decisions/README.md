...
- `phase-1-decisions.md`: the initial decisions from Stage I
- `phase-status.md`: the current phase, status, and confirmation checkpoint
- `phase-log.md`: optional running log of phase changes, if the project needs more detail

## How to use it

1. Fill in `phase-1-decisions.md` before moving out of Stage I.
...
4. Keep the entries short, factual, and aligned with the agreed plan.
